...
typedef struct _bno055_t {
    ...
    error_bno (*bno055_remap_axis)(struct _bno055_t* imu,
...
error_bno bno055_set_acc_conf(bno055_t* bno, const bno055_acc_range_t range,
                              const bno055_acc_band_t bandwidth,
                              const bno055_acc_mode_t mode);
error_bno bno055_set_gyr_conf(bno055_t* bno, const bno055_gyr_range_t range,
                              const bno055_gyr_band_t bandwidth,
                              const bno055_gyr_mode_t mode);
error_bno bno055_set_mag_conf(bno055_t* bno, const bno055_mag_rate_t out_rate,
