...
#ifdef DP1_X_OFFSET
#define DP1_X_OFFSET_LOWER (SSD1306_X_OFFSET & 0x0F)
#define DP1_X_OFFSET_UPPER ((SSD1306_X_OFFSET >> 4) & 0x07)
#else
#define DP1_X_OFFSET_LOWER 0
#define DP1_X_OFFSET_UPPER 0
#endif
...
#ifndef DP1_I2C_PORT
#define DP1_I2C_PORT        hi2c1
#endif

#ifndef DP1_I2C_ADDR
#define DP1_I2C_ADDR        (0x3C << 1)
#endif
...
#ifndef DP1_SPI_PORT
#define DP1_SPI_PORT        hspi2
#endif

#ifndef DP1_CS_Port
#define DP1_CS_Port         GPIOB
#endif
#ifndef DP1_CS_Pin
#define DP1_CS_Pin          GPIO_PIN_12
#endif

#ifndef DP1_DC_Port
#define DP1_DC_Port         GPIOB
#endif
#ifndef DP1_DC_Pin
#define DP1_DC_Pin          GPIO_PIN_14
#endif

#ifndef DP1_Reset_Port
#define DP1_Reset_Port      GPIOA
#endif
#ifndef DP1_Reset_Pin
#define DP1_Reset_Pin       GPIO_PIN_8
#endif

/* ^^^ SPI config ^^^ */

#if defined(DP1_USE_I2C)
extern I2C_HandleTypeDef DP1_I2C_PORT;
...
#ifndef DP1_HEIGHT
#define DP1_HEIGHT          64
#endif

// SSD1306 width in pixels
#ifndef DP1_WIDTH
#define DP1_WIDTH           128
#endif

#ifndef DP1_BUFFER_SIZE
#define DP1_BUFFER_SIZE   DP1_WIDTH * DP1_HEIGHT / 8
#endif

// Enumeration for screen colors
typedef enum {
    DP1_Black = 0x00, // Black color, no pixel
    DP1_White = 0x01  // Pixel is set. Color depends on OLED
} DP1_COLOR;

typedef enum {
    DP1_OK = 0x00,
    DP1_ERR = 0x01  // Generic error.
} DP1_Error_t;
...
void dp1_DrawCircle(uint8_t par_x, uint8_t par_y, uint8_t par_r, DP1_COLOR color);
